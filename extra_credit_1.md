## Refer to extra credit question 1
```python
...
def query(face, database):
    ...
    # executing SVD (Python inbuilt function)
    ...
    print()
    #print(green('The images of unknown subject and closely identified match is below',['reverse']))
